            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-12">
                <div className="team-thumb">
                  <img src="images/team/matthew-hamilton-tNCH0sKSZbA-unsplash.webp" className="img-fluid team-image" alt="" />
              ...
              <div className="col-lg-4 col-12 my-lg-0 my-4">
                <div className="team-thumb">
                  <img src="images/team/nicolas-horn-MTZTGvDsHFY-unsplash.webp" className="img-fluid team-image" alt="" />
              ...
              <div className="col-lg-4 col-12">
                <div className="team-thumb">
                  <img src="images/team/rc-cf-FMh5o5m5N9E-unsplash.webp" className="img-fluid team-image" alt="" />
              ...
              <div className="col-lg-6 col-12 d-flex align-items-center mt-5 mt-lg-0 mx-auto">
                <div className="subscribe-form-wrap">
                  ...
                  <form className="custom-form subscribe-form mt-4" role="form">
                    <input type="email" name="subscribe-email" id="subscribe-email" pattern="[^ @]*@[^ @]*" className="form-control" placeholder="Your email address" />
