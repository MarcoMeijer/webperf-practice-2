  ...
  const renderCocktail = ({ index, key, style }) => {
    ...
    return (<div key={key} className="col-lg-4 col-md-6 col-12" style={style}>
      <div className="flex flex-row">
        <img src={drink.strDrinkThumb} className="img-fluid menu-image" alt="" height={rowHeight} width={rowHeight} />

        <div className="flex flex-col">
          <h4 className="mb-0">{drink.strDrink}</h4>
          <h5 className="mb-0 text-neutral-500 text-lg">Ingredients:</h5>
      ...
      <section className="menu section-padding">
        <div className="container">
          <div className="row">
            ...
            <List height={600} width={1200} rowHeight={rowHeight} rowCount={isLoaded ? data.drinks?.length ?? 0 : 0} rowRenderer={renderCocktail} />
          </div>
        </div>
      </section>
