      ...
      <section className="menu section-padding">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 col-12">
              <div className="menu-thumb">
                <img src="images/breakfast/lucas-swennen-1W_MyJSRLuQ-unsplash.webp" className="img-fluid menu-image" alt="" />
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-12">
              <div className="menu-thumb">
                <img src="images/lunch/louis-hansel-cH5IPjaAYyo-unsplash.webp" className="img-fluid menu-image" alt="" />
            ...
            <div className="col-lg-6 col-12">
              <div className="menu-thumb">
                <img src="images/lunch/louis-hansel-rheOvfxOlOA-unsplash.webp" className="img-fluid menu-image" alt="" />
      ...
      <section className="menu section-padding">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 col-12">
              <div className="menu-thumb">
                <img src="images/dinner/farhad-ibrahimzade-isHUj3N0194-unsplash.webp" className="img-fluid menu-image" alt="" />
